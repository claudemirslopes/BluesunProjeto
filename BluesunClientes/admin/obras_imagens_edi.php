...
<?php
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT * FROM obras_imagens WHERE image_id =:uid');
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('UPDATE obras_imagens
                                         SET titulo=:utitulo, 
                                             date=:udate
                                       WHERE image_id=:uid');
            ...
            if($stmt->execute()){
                ...
                window.location.href='obras_imagens.php';
                </script>
                <?php
            }
            else{
                                ...
                                <form role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6" style="padding-left: 15px;">
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="image_id" class="form-control border-input" value="<?php echo $image_id; ?>" style="background-color: #fff; border: 1px hidden #fff;border-bottom: 1px dashed #ccc;font-size: 1.5em;" readonly>
