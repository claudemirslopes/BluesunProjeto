...
<?php
    ...
    {
        $depoimento_id_user = $_POST['depoimento_id_user'];// user name
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('INSERT INTO depoimentos(depoimento_id_user,nome,cargo,texto,datacad,datamod,userPic) VALUES(:udepoimento_id_user, :unome, :ucargo, :utexto, :udatacad, :udatamod,  :uuserPic)');
            $stmt->bindParam(':udepoimento_id_user',$depoimento_id_user);
            ...
            if($stmt->execute())
            {
                ...
                header("refresh:1;depoimentos.php"); // redirects image view page after 5 seconds.
            }
            else
            {
