...
<head>
	...
	<title>Bluesun do Brasil | Usuarioso</title>
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: #CEF6CE;">
                            <div class="header">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                <label>ID</label>
                                                <input type="text" name="id" class="form-control border-input" placeholder="Digite o nome" value="<?php echo $id; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input type="text" name="nome" class="form-control border-input" placeholder="Digite o nome" value="<?php echo $nome; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">E-mail</label>
                                                <input type="email" name="email" class="form-control border-input" placeholder="Digite o e-mail" value="<?php echo $email; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="id_situacoes" class="form-control border-input" value="<?php echo $id_situacoes == '1' ? 'Ativo' : 'Inativo'; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
