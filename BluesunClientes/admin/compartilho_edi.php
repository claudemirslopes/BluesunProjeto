                        ...
                        <div class="card" style="background-image: url(../img/pattern/pat-3.png);">
                            <div class="col-md-12" style="margin-bottom: 20px;">
                                <div class="header col-lg-8">
                                    ...
                                    <p class="category" style="font-size: 1.2em;color: #555;">Altere as informações de compartilhamento em rede social.</p>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtArtigo" name="descricao" class="form-control border-input" rows="4" placeholder="Digite a descrição" required="" style="background-color: #fff; border: 1px hidden #fff;border-bottom: 1px dashed #ccc;font-size: 1.2em;"><?php echo $descricao; ?></textarea>
                                            </div>
