...
<?php
    ...
    if(isset($_POST['btnsave']))
    {
        ...
        if(!isset($errMSG))
        {
            $stmt = $DB_con->prepare('INSERT INTO marcas(titulo,datacad,datamod,userPic) VALUES(:utitulo, :udatacad, :udatamod,  :uuserPic)');
            ...
            if($stmt->execute())
            {
                ...
                header("refresh:1;marcas.php"); // redirects image view page after 5 seconds.
            }
            else
            {
