...
jQuery(document).ready(function() {
	...
	*/
	$('.slider-2-container').backstretch([
	  "assets/img/slider/sld1.jpg"
	, "assets/img/slider/sld2.jpg"
	, "assets/img/slider/sld3.jpg"
	, "assets/img/slider/sld4.jpg"
            ...
            success: function(json) {
                ...
                if(json.nameMessage == '' && json.emailMessage == '' && json.messageMessage == '') {
                	form.fadeOut('fast', function() {
                		form.parent('.contact-form').append('<p><span class="violet">Obrigado por entrar em contato conosco!</span> Retornaremos o seu contato em breve.</p>');
                    });
                }
            }
        });
