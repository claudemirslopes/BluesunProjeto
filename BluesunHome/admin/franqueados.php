                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a title="Editar" href="franqueados-edt.php?edit_id=<?php echo $rows_cursos['id_franqueado']; ?>"><i class="fa fa-edit" style="color: #1CC88A;"></i></a>
                            	<a title="Excluír" href="?delete_id=<?php echo $rows_cursos['id_franqueado']; ?>" onclick="return confirm('Confirma a exclusão?')"><i class="fa fa-trash" style="color: #ff0000;"></i></td>
                          </tr> 
                          <?php } ?>                       
                        </tbody>
                      </table>
