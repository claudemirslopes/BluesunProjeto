...
//$mail->SMTPDebug = 3;                               // Enable verbose debug output
    ...
    $mail->Host = 'mail.bluesundobrasil.com.br';                    // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'ti@bluesundobrasil.com.br';                 // SMTP username
    $mail->Password = 'Eliane19@';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 465;                                    // TCP port to connect to

    $mail->setFrom('ti@bluesundobrasil.com.br', 'Bluesun do Brasil');
