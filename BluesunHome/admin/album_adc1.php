            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Adicionar Álbum</h4>
                            </div>
                            <div class="content">
                                <?php
                                    if(isset($errMSG)){
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtArtigo" name="album_texto" class="form-control border-input" rows="4" placeholder="Digite a descrição" required=""><?php echo $album_texto; ?></textarea>
                                            </div>
