<?php
  ...
  include_once("conn/conexao/conexao.php");
?>
...
.divbaixo {
  ...
  ?>
    ...
    <section id="franquia" class="section-with-bg wow fadeInUp" style="background-color: #f7f7f7;">
      <div class="container">

        <div class="section-header">
          <h2 style="font-size: 3.0em;letter-spacing: -0.06em;color: #61AB45;text-transform: capitalize;font-weight: bold;font-family: 'Source Sans Pro', sans-serif;font-weight: 900;">Franqueados</h2>
      ...
      <div class="row mt-4">
        ...
        <?php
        $uf = $_GET['uf'];
        $stmt = $DB_con->prepare("SELECT * FROM bs_franqueados WHERE  uf LIKE '%".$uf."%' ORDER BY cidade");
        $stmt->execute();
        if($stmt->rowCount() > 0)
        {
        ...
        <div class="col-lg-4 mt-3">
          <div class="card text-center">
            <div class="card-header text-light" style="background-color: #F36B2B;">
              <?php if ($row['modalidade'] == 'Loja') {
                echo '<i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;'.$row['modalidade'];
              } else {
                echo '<i class="fa fa-home" aria-hidden="true"></i>&nbsp;'.$row['modalidade'];
              } ?>
            </div>
            <div class="card-body border">
              <h5 class="card-title"><?php echo $row['empresa']; ?></h5>
              <p class="card-text text-center"><?php echo $row['cidade'].'/'.$row['uf']; ?><br>
                <span style="font-size: .8em;"><a href="tel:<?php echo $row['telefone']; ?>" st><?php echo $row['telefone']; ?></a><br>
                <a href="mailto:<?php echo $row['email']; ?>"><?php echo $row['email']; ?></a></span>
              </p>
            </div>
          </div>
        </div>
        <?php }
              ...
              <div class="col-xs-12">
                <div class="alert alert-info">
                    <span><i class="fa fa-info-circle" aria-hidden="true"></i></span> &nbsp; Não foram encontrados franquias para esta unidade da federação...
                  </div>
              </div>
        <?php } ?>
    ...
    <section class="section-with-bg wow fadeInUp" style="background-color: #fff; margin: 80px;margin-top: -10px;">
      <hr/>
      ...
      <div class="row">
        ...
        <div class="col-md-1 externa">
          <div class="externa">
            <a href="pesquisa.php?uf=AC#franquia" style="color: #373737;"><div class="card text-center cont1 imagem3">
              <div class="card-body">
